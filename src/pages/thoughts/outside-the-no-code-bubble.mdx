...
import Shane from '../../assets/shane-waking-digital.png';
...
"Of course! 🙃". <span class="parens">(Me thinking about all of the GDPR Compliant alternatives like <a href="https://plausible.io/">Plausible</a> and <a href="https://usefathom.com/">Fathom</a>)</span>
...
<a href="https://finsweet.com/cookie-consent">Finsweet's Cookie Consent</a>: The end all be all.
...
<BlockQuote avatar={Shane} author="Shane from Waking Digital" link1="https://x.com/digitalshane_" pill1="@digitalshane_" website="https://www.wakingdigital.com/"><p>The Finsweet Components Cookie Consent has got to be one of the worst experiences ever.</p><p>Literally done with it.</p><p>It cannot be trusted.</p><p>Add it to staging and it breaks in production. Has made us look bad now twice with clients.</p></BlockQuote>
...
A reddit post lead me to <a href="https://orestbida.com/">Orest Bida</a>, an Italian freelance website designer with 35 followers on twitter (This should be higher). Orest authored <a href="https://github.com/orestbida/cookieconsent">cookieconsent</a> that has 4,000+ stars on Github that solved my exact issue.
